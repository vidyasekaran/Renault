...
import com.nissangroups.pd.b000021.mapper.MstMnthlyOrdrTkBsPrdRowMapperPK;


@Entity
public class MstMnthlyOrdrTkBsPrdRowMapper implements Serializable{
	
	/** Constant serialVersionUID. */
	private static final long serialVersionUID = 1L;
	
	@EmbeddedId
	MstMnthlyOrdrTkBsPrdRowMapperPK id;
	
	public MstMnthlyOrdrTkBsPrdRowMapperPK getId() {
		return id;
	}
	
	public void setId(MstMnthlyOrdrTkBsPrdRowMapperPK id){
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof MstMnthlyOrdrTkBsPrdRowMapper)) {
			return false;
		}
		MstMnthlyOrdrTkBsPrdRowMapper other = (MstMnthlyOrdrTkBsPrdRowMapper) obj;
