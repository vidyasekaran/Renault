 ...
 * Function ID     :PST-DRG-B000002UpdateReceivedOseiReader
 ...
 * @version V1.0
 */
public class B000002UpdateReceivedOseiReader implements ItemReader<List<Object[]>>{
	
	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog(B000002UpdateReceivedOseiReader.class);
	...
	/** Variable ei updtd uk osei details list. */
	private List<Object[]> eiUpdtdUkOseiDetailsList = new ArrayList<Object[]>();
	
	/** Variable fetch updated osei details. */
