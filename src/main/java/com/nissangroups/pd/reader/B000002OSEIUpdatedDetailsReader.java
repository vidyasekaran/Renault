 ...
 * Function ID     :PST-DRG-B000002OSEIUpdatedDetailsReader
 ...
 * @version V1.0
 */
public class B000002OSEIUpdatedDetailsReader implements ItemReader<List<Object[]>>{
	
	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog(B000002OSEIUpdatedDetailsReader.class);
