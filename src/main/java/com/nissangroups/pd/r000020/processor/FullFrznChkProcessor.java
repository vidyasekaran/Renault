 ...
 * Process Outline : Validate the Full Frozen Orders(Frozen Type - F) present in Monthly Order Interface TRN 
 *
 * <Revision History>
...
public class FullFrznChkProcessor implements
		ItemProcessor<InputBean, InputBean> {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog
			(FullFrznChkProcessor.class);
	...
	public InputBean process(InputBean input) throws PdApplicationException {
		...
		List<Object[]> fullFrznRcrds =  frznVldnRepositoryObj.fetchFrznSummrzdOrdrQty(input,"F","true",null,"false");
			
		frznVldnRepositoryObj.doFrznVldn(fullFrznRcrds, "19", input,"F");
