 ...
 *
 */
package com.nissangroups.pd.i000110.main;
 ...
 *
 */
public class I000110 {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog(I000110.class);

	/** Constant ARG LENGTH. */
	private static final int ARG_LENGTH = 2;

	/**
	 * Instantiates a new I000110.
	 */
	private I000110() {
	}

	/**
	 * Interface I000110 Execution Start from this Main Method.
	 * 
	 * @param args
	 *            the arguments
	 */
	public static void main(String[] args) {
		...
		LOG.info("IF110 Args : " + Arrays.deepToString(args));
	...
	private static void run(String[] args) {
		...
		String[] batchConfig = { PDConstants.INTERFACE_I110_CONFIG_PATH };
		String interfaceFileId = args[0];
		ApplicationContext context = new ClassPathXmlApplicationContext(
				batchConfig);
		JobLauncher jobLauncher = (JobLauncher) context.getBean("jobLauncher");
		Job job = (Job) context.getBean(PDConstants.IF_ID_110);
		try {
