...
public class B000059FormatValProcessor implements
	...
	/**
	 * method used to call performformatValidation to validate the format
	 * 
	 * @param item
	...
	public B000059FileVO process(B000059FileVO item)
		...
		dataValService.performformatValidation(item, commonutility.getFileSpecVO().getInterfaceFileId());
		return item;
	}
