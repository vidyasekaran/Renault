 ...
 * Module          :
 * Process Outline :This program validates the Data Type of incoming data.
 *
 * <Revision History>
...
public class B000059TypeValProcessor implements
	...
	/**
	 * method used to call performtypeValidation to validate the type
	 * 
	 * @param item
	...
	public B000059FileVO process(B000059FileVO item)
		...
		dataValService.performtypeValidation(item, commonutility.getFileSpecVO().getInterfaceFileId());
		return item;
	}
