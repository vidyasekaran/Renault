 ...
 *
 */
package com.nissangroups.pd.i000014.processor;
...
import com.nissangroups.pd.i000014.output.I000014OutputBean;
...
/**
 * This class is used to process and do the business logic for the interface I000014.
 * 
 * @author z015895
 *
 */
public class I000014Processor implements
		ItemProcessor<I000014OutputBean, CmnInterfaceData> {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog
			(I000014Processor.class);
	...
	/*
	 * This method is to process OEI Feature OCF Interface and insert the list into Common Interface data.
	 * (non-Javadoc)
	 * 
	 * @see
	 ...
	 */
	@Override
	public CmnInterfaceData process(I000014OutputBean item) throws Exception {
		...
		cmnIfData.setCol8(item.getOeifAdoptDate());
		cmnIfData.setCol9(item.getOeifAbolishDate());
		cmnIfData.setCol10(item.getOeifAdoptDate());
		cmnIfData.setCol11(item.getOeifAbolishDate());
		cmnIfData.setCol12(item.getFeatureTypeCd());
		cmnIfData.setCol13(item.getFeatureCd());
		cmnIfData.setCol14(item.getOcfFrameCd());
		cmnIfData.setCol15(item.getFeatureShortDescription());
		cmnIfData.setCol16(item.getOcfBuyerGroupCd());
		cmnIfData.setCol17(item.getCarGroup());
		cmnIfData.setCol18(item.getCreateUserID());
		cmnIfData.setCol19(item.getCreateDateTime());
		cmnIfData.setCol20(item.getUpdateUserID());
		cmnIfData.setCol21(item.getUpdateDateTime());
