...
/**
* FailProcessor class for B000014
*
* @author z015399
*/
public class FailProcessor implements
ItemProcessor<B000014InputMapper,B000014Output>{
	
	private static final Log LOG = LogFactory.getLog(FailProcessor.class.getName());
	...
	public B000014Output process(B000014InputMapper objInputMapper) throws Exception{
		...
		objPlantOCFRepository.updateFailedStatus(porCd,otbm,entityManager);
