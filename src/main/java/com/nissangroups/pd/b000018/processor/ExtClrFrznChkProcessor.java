 ...
 * Process Outline : Validate the Exterior Color Frozen Orders(Frozen Type - E) present in Monthly Order Interface TRN 
 *
 * <Revision History>
...
public class ExtClrFrznChkProcessor implements
		ItemProcessor<InputBean, InputBean> {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog
			(ExtClrFrznChkProcessor.class);
	...
	public InputBean process(InputBean input) throws PdApplicationException {
		...
		List<Object[]> extClrFrznRcrds =  frznVldnRepositoryObj.fetchFrznSummrzdOrdrQty(input,"E","true",null,"false");
			
		frznVldnRepositoryObj.doFrznVldn(extClrFrznRcrds, "21", input,"E");
