...
public class AttchOseiIdProcessor implements
		ItemProcessor<InputBean, InputBean> {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog
			(AttchOseiIdProcessor.class);
	...
	public InputBean process(InputBean input) throws PdApplicationException {
		...
		LOG.info(STEP_AFTER_START);
			...
			List<Object[]> oseiDtlsList =  mnthlyOrdrIfTrnRepositoryObj.fetchOseiIdForEI(input);
			
			mnthlyOrdrIfTrnRepositoryObj.updateOseiId(oseiDtlsList, input);
