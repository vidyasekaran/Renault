 ...
 * Process Outline : Validate the Destination Frozen Orders(Frozen Type - D) present in Monthly Order Interface TRN 
 *
 * <Revision History>
...
public class SpecDestFrznChkProcessor implements
		ItemProcessor<InputBean, InputBean> {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog
			(SpecDestFrznChkProcessor.class);
	...
	public InputBean process(InputBean input) throws PdApplicationException {
		...
		List<Object[]> specDestFrznRcrds =  frznVldnRepositoryObj.fetchFrznSummrzdOrdrQty(input,"D","true",null,"false");
			
		frznVldnRepositoryObj.doFrznVldn(specDestFrznRcrds, "23", input,"D");
