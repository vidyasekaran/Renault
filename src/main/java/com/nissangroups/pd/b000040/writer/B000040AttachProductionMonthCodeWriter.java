 ...
 */
public class B000040AttachProductionMonthCodeWriter implements
		ItemWriter<B000040OrdrDtlsOutputBean> {
	/* Constant LOG */
	private static final Log LOG = LogFactory
			.getLog(B000040AttachProductionMonthCodeWriter.class.getName());
	/**
	...
	public void beforeStep(StepExecution stepExecution)
		...
		String updtOrdrDtilsTmp = B000040QueryConstants.updateProductionMonthCode.toString();
	...
	public void addRecord(B000040OrdrDtlsOutputBean item) {
		try {
			preparedStmt.setString(1, queryDataService.getProductionMonthCode(item));					
