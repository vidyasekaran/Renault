 ...
 */
public class B000040AttachExNoMapSymbolsTrueWriter implements
		ItemWriter<B000040OrdrDtlsOutputBean> {
	/* Constant LOG */
	private static final Log LOG = LogFactory
			.getLog(B000040AttachExNoMapSymbolsTrueWriter.class.getName());
	/**
	...
	public void beforeStep(StepExecution stepExecution)
		...
		String updtOrdrDtilsTmp = B000040QueryConstants.updateExNoMapSymbolTrue.toString();
	...
	public void addRecord(B000040OrdrDtlsOutputBean item) {
		try {
			...
			preparedStmt.setString(2, resultMap.get("EX-NO"));			
			preparedStmt.setString(3, resultMap.get("End Item"));	
			preparedStmt.setString(4, resultMap.get("PRODUCTION FAMILY CODE"));	
			preparedStmt.setString(5, resultMap.get("ADDITIONAL SPEC CODE"));	
			preparedStmt.setString(6, resultMap.get("SPEC DESTIANTION CODE"));	
			preparedStmt.setString(7, resultMap.get("BUYER CODE"));	
			preparedStmt.setString(8, resultMap.get("BUYER GROUP CODE"));
			preparedStmt.setString(9, resultMap.get("CAR SERIES"));	
			
			String salsNo = queryDataService.getSalesNotesNumber(item);
			preparedStmt.setString(10, salsNo);//SALES_NOTE_NO
			preparedStmt.setString(11, item.getPorCd());			
			preparedStmt.setString(12, item.getOseiId());	
