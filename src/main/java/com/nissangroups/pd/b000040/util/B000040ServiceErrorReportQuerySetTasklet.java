 ...
 *
 */
public class B000040ServiceErrorReportQuerySetTasklet implements Tasklet, InitializingBean {

	private static final Log LOG = LogFactory
			.getLog(B000040ServiceErrorReportQuerySetTasklet.class.getName());
