 ...
 *
 */
public class B000040WklyOrdSpecErrorReportQuerySetTasklet implements Tasklet, InitializingBean {

	private static final Log LOG = LogFactory
			.getLog(B000040WklyOrdSpecErrorReportQuerySetTasklet.class.getName());
