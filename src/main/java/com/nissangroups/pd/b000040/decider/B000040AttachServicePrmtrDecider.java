...
public class B000040AttachServicePrmtrDecider implements JobExecutionDecider {
	...
	private static final Log LOG = LogFactory
			.getLog(B000040AttachServicePrmtrDecider.class.getName());
	...
	public FlowExecutionStatus decide(JobExecution jobExecution,
		...
		queryDataService.attachServicePrmtr(queryInputVO.getPorCD());
				
		queryInputVO.setAttachServiceParam(true);				
		
		String status = queryInputVO.isAttachServiceParam() ? "true" : "false";	
