...
/**
 * The primary key class for the TRN_BUYER_MNTHLY_OCF_USG database table.
 * 
 */
@Embeddable
public class TrnBuyerMnthlyOcfUsgPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnBuyerMnthlyOcfUsgPK)) {
			return false;
		}
		TrnBuyerMnthlyOcfUsgPK castOther = (TrnBuyerMnthlyOcfUsgPK)other;
		return 
