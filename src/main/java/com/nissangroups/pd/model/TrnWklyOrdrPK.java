...
/**
 * The primary key class for the TRN_WKLY_ORDR database table.
 * 
 */
@Embeddable
public class TrnWklyOrdrPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnWklyOrdrPK)) {
			return false;
		}
		TrnWklyOrdrPK castOther = (TrnWklyOrdrPK)other;
		return 
