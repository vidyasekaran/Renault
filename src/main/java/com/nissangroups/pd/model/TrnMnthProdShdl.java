...
/**
 * The persistent class for the TRN_MNTH_PROD_SHDL database table.
 * 
 */
@Entity
@Table(name="TRN_MNTH_PROD_SHDL")
@NamedQuery(name="TrnMnthProdShdl.findAll", query="SELECT t FROM TrnMnthProdShdl t")
public class TrnMnthProdShdl implements Serializable {
	

	@EmbeddedId
	private TrnMnthProdShdlPK id;
	...
	public TrnMnthProdShdl() {
	}

	public TrnMnthProdShdlPK getId() {
		return this.id;
	}

	public void setId(TrnMnthProdShdlPK id) {
		this.id = id;
	}
