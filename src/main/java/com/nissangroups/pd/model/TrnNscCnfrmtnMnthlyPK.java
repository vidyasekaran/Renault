...
/**
 * The primary key class for the TRN_NSC_CNFRMTN_MNTHLY database table.
 * 
 */
@Embeddable
public class TrnNscCnfrmtnMnthlyPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnNscCnfrmtnMnthlyPK)) {
			return false;
		}
		TrnNscCnfrmtnMnthlyPK castOther = (TrnNscCnfrmtnMnthlyPK)other;
		return 
