...
/**
 * The persistent class for the TRN_WKLY_PROD_SHDL database table.
 * 
 */
@Entity
@Table(name="TRN_WKLY_PROD_SHDL")
@NamedQuery(name="TrnWklyProdShdl.findAll", query="SELECT t FROM TrnWklyProdShdl t")
public class TrnWklyProdShdl implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TrnWklyProdShdlPK id;
	...
	@Column(name="WK_FX_SYMBL")
	private String wkFxSymbl;

	@Column(name="WK_FX_WK_NO")
	private String wkFxWkNo;
	...
	public TrnWklyProdShdl() {
	}

	public TrnWklyProdShdlPK getId() {
		return this.id;
	}

	public void setId(TrnWklyProdShdlPK id) {
		this.id = id;
	}
	...
	public String getWkFxSymbl() {
		return this.wkFxSymbl;
	}

	public void setWkFxSymbl(String wkFxSymbl) {
		this.wkFxSymbl = wkFxSymbl;
	}

	public String getWkFxWkNo() {
		return this.wkFxWkNo;
	}

	public void setWkFxWkNo(String wkFxWkNo) {
		this.wkFxWkNo = wkFxWkNo;
	}
