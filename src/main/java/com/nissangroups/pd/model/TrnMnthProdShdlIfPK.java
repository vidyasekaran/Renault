 ...
 */
@Embeddable
public class TrnMnthProdShdlIfPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnMnthProdShdlIfPK)) {
			return false;
		}
		TrnMnthProdShdlIfPK castOther = (TrnMnthProdShdlIfPK)other;
		return 
