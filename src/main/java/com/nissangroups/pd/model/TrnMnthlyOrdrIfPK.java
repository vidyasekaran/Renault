...
/**
 * The primary key class for the TRN_MNTHLY_ORDR_IF database table.
 * 
 */
@Embeddable
public class TrnMnthlyOrdrIfPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnMnthlyOrdrIfPK)) {
			return false;
		}
		TrnMnthlyOrdrIfPK castOther = (TrnMnthlyOrdrIfPK)other;
		return 
