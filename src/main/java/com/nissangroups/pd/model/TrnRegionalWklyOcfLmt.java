...
/**
 * The persistent class for the TRN_REGIONAL_WKLY_OCF_LMT database table.
 * 
 */
@Entity
@Table(name="TRN_REGIONAL_WKLY_OCF_LMT")
@NamedQuery(name="TrnRegionalWklyOcfLmt.findAll", query="SELECT t FROM TrnRegionalWklyOcfLmt t")
public class TrnRegionalWklyOcfLmt implements Serializable {
	

	@EmbeddedId
	private TrnRegionalWklyOcfLmtPK id;
	...
	public TrnRegionalWklyOcfLmt() {
	}

	public TrnRegionalWklyOcfLmtPK getId() {
		return this.id;
	}

	public void setId(TrnRegionalWklyOcfLmtPK id) {
		this.id = id;
	}
