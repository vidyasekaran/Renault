...
/**
 * The primary key class for the TRN_DAILY_OCF_LMT database table.
 * 
 */
@Embeddable
public class TrnDailyOcfLmtPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TrnDailyOcfLmtPK)) {
			return false;
		}
		TrnDailyOcfLmtPK castOther = (TrnDailyOcfLmtPK)other;
		return 
