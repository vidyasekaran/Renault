 ...
 */
public class I000010 {

	/** Constant LOG. */
	private static final Log LOG = LogFactory.getLog(I000010.class.getName());
	...
	/**
	 * Instantiates a new i000010.
	 */
	private I000010() {
	}

	/**
	 * Batch I000010 Execution Start from this Main Method.
	 *
	 * @param args
	 *            the arguments
	 */
	...
	private static void run() {
		String[] batchConfig = { "I000010/I000010_IF_Config.xml" };
		ApplicationContext context = new ClassPathXmlApplicationContext(
				batchConfig);
		JobLauncher jobLauncher = (JobLauncher) context.getBean("jobLauncher");
		Job job = (Job) context.getBean(PDConstants.INTERFACE_ID_I000010);
		try {
			...
			parameter
					...
					.addString(PDConstants.PARAMETER_CD,PDConstants.COMMON_INTERFACE_NAME_PARAMETER_CD)
					.toJobParameters();
			jobLauncher.run(job, parameter.toJobParameters());
		} catch (Exception e) {
			LOG.error(PDConstants.INTERFACE_ID_I000010, e);
		}
	}
}
