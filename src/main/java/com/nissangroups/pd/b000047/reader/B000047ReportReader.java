...
/**
* The Class B000047ReportReader read the data from B000047 error report class and process .
* 
* @author z016127
*/
public class B000047ReportReader implements ItemReader<B000047ReportDao> {
		...
		public B000047ReportDao read() throws Exception {
			...
			LOG.info(REPORT_SIZE +b000047ReportDao.getReportList().size());
			if(currentIndex < b000047ReportDao.getReportList().size()){
				LOG.info(DOLLAR + OUTSIDE_METHOD + DOLLAR);
				return b000047ReportDao.getReportList().get(currentIndex++);
			}
			else{
			LOG.info(DOLLAR + OUTSIDE_METHOD + DOLLAR);
			return null;
